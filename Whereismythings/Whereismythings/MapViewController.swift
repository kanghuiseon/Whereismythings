...
class MapViewController: UIViewController, CLLocationManagerDelegate {
    ...
    override func viewDidLoad() {
        ...
        // 핀 꽂기
        for mapModel in stuffs{
            setAnnotation(latitude: Double(mapModel.stuffLatitudePosition)!, longitude: Double(mapModel.stuffLongitudePosition)!, delta: 0.01, Title: mapModel.stuffName, subTitle: nil)
        }
